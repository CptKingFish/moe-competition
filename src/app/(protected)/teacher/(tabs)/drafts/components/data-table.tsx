...
import DataTableToolbar from "@/app/(protected)/teacher/(tabs)/drafts/components/data-table-toolbar";
...
type DataTableProps<TValue> = {
  ...
  data: RouterOutputs["teacher"]["getProjectDrafts"]["data"];
  pageCount: RouterOutputs["teacher"]["getProjectDrafts"]["pageCount"];
};
